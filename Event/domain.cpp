...
/*std::ostream& operator<<(std::ostream &output, const Event& print_event){
    output << print_event.title << " // " << print_event.description << " // " << print_event.date_time << " // " << print_event.number_people << " // " << print_event.link << "\n";
    return output;
}*/